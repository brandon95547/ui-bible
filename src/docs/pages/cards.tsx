      ...
      render: (
        <Card interactive as="a" padding="sm" className="w-52">
          ...
          <Row gap="sm" className="mt-2">
            <a href="#/cards" className="text-caption text-[var(--ds-accent-text)] underline">Settings</a>
            <a href="#/cards" className="text-caption text-[var(--ds-accent-text)] underline">Logs</a>
          </Row>
        </Card>
      ),
    },
