...
.ds-btn--filled {
  ...
  tokens: [
    ...
    { category: 'color', group: 'Surfaces', token: '--ds-surface-raised', usedFor: 'A surface sitting above another surface' },
    { category: 'color', group: 'Surfaces', token: '--ds-surface-overlay', usedFor: 'Dialogs, popovers, menus, toasts' },
    { category: 'color', group: 'Surfaces', token: '--ds-surface-inset', usedFor: 'Wells: inputs, code blocks, table headers' },
    { category: 'color', group: 'Interaction layers', token: '--ds-layer-hover', usedFor: 'Alpha wash applied on hover, composes over anything' },
    { category: 'color', group: 'Interaction layers', token: '--ds-layer-selected', usedFor: 'Persistent selection tint' },
    { category: 'color', group: 'Foreground', token: '--ds-fg', usedFor: 'Primary text' },
    { category: 'color', group: 'Foreground', token: '--ds-fg-secondary', usedFor: 'Body text, labels' },
    { category: 'color', group: 'Foreground', token: '--ds-fg-muted', usedFor: 'Captions, metadata, placeholders' },
    { category: 'color', group: 'Foreground', token: '--ds-fg-disabled', usedFor: 'Disabled text — exempt from contrast rules' },
    ...
    { category: 'color', group: 'Borders', token: '--ds-border-strong', usedFor: 'Checkbox and radio outlines, scrollbars' },
    { category: 'color', group: 'Brand & focus', token: '--ds-accent', usedFor: 'Brand actions and selection' },
    { category: 'color', group: 'Brand & focus', token: '--ds-focus-ring', usedFor: 'The single focus outline, tuned to clear 3:1 everywhere' },
